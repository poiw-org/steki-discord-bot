...
const restartRegistration = async (channel, user) => {
    ...
    setTimeout(()=>channel.send("Αν κολλήσεις σε κάποιο απο τα βήματα (βάλεις λάθος ακαδημαϊκό email, δεν λαμβάνεις κωδικό κτλ. πάτα το :arrows_counterclockwise: εδώ κάτω και θα ξανα-αρχίσουμε τη διαδικασία πό την αρχή.").then(message=>message.react("🔄")),3000)
}
