    ...
    execute: async (bot) => {
        bot.on('guildMemberAdd', (guildMember) => {
            ...
            channel.then(channel => {
                ...
                channel.send(`**Γειά σου ${user.username}, καλωσήρθες στο Steki!** \n Για να διασφαλίσουμε την εχμύθεια και την αποκλειστικότητα του σέρβερ προς τους φοιτητές και φοιτήτριες του ΕΛ.ΜΕ.ΠΑ., θα χρειαστεί να επιβεβαιώσουμε την φοιτητική σου ιδιότητα.\n\nΕίναι πολύ απλό: \n **Θα σου στείλω έναν κωδικό στο ακαδημαϊκό σου email και εσύ θα πρέπει να μου τον στείλεις πίσω.**`);
                setTimeout(()=>channel.send("Αν κολλήσεις σε κάποιο απο τα βήματα (βάλεις λάθος ακαδημαϊκό email, δεν λαμβάνεις κωδικό κτλ. πάτα το :arrows_counterclockwise: εδώ κάτω και θα ξανα-αρχίσουμε τη διαδικασία πό την αρχή.").then(message=>message.react("🔄")),1000)
